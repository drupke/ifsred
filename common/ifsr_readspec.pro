...
; :History:
;    ChangeHistory::
;      09aprXY, DSNR, created (because there is nothing like it in Astrolib)
...
;
;-
function ifsr_readspec,infile,extension=extension,header=header
